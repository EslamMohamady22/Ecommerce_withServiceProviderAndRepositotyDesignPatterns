                            ...
                            <div class="digital-add needs-validation">
                                <form action="{{ route('dashboard.Products.update', $product->id) }}" method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control colors" value="{{$product->colors}}" multiple="multiple" name="colors[]" value="{{$product->color}}">
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control sizes" value="{{$product->size}}" multiple="multiple" name="sizes[]" value="{{$product->size}}">
                                            </select>
                                        </div>
                                ...
                                @foreach($product->images as $image)
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{route('dashboard.Products.images.delete' , ['id' => $image->id])}}"><i class="fa fa-trash"></i></a>
                                    </div>
                                @endforeach
